...
```{r raw_data, cache=T}
sheets_id <- as_sheets_id("https://docs.google.com/spreadsheets/d/10TLHYACXrkFUmGaoKCiRes1NMckH3RVXnBJ-4kUC-qY/edit?usp=sharing")
...
``` {r excluding_studies}
exclude_from_analysis <- c('isaric_1', 'isaric_2', 'isaric_3', 'miyara_old', 'isaric_4', 'mehra', 'hopkinson', 'gaibazzi', 'miyara_updated')
...
testing_rr[[19]] <- RR_testing('Govind', 'former')
testing_rr[[20]] <- RR_testing('Gu', 'current')
testing_rr[[20]] <- RR_testing('Gu', 'former')
...
```
The number of **Fair** quality studies are `r paste(fair)` with the number of **Poor** quality studies equal to `r paste(poor)`